              ...
              @endforeach --}}
                ...
                <div class="form-group">
                    ...
                    <input id="discount" type="number" name="discount" min="0" max="100"
                        placeholder="Entrer le pourcentage de reduction" value="{{ old('discount') }}" class="form-control">
                    @error('discount')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group mb-3">
                    <button type="reset" class="btn btn-warning">Rénitialiser</button>
            ...
            if (cat_id != null) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        var html_option = "<option value=''>----Selectionner une sous categorie----</option>"
                        if (response.status) {
