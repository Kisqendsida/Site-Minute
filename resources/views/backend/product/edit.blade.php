    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="post" action="{{ route('product.update', $product->id) }}">
                ...
                <div class="form-group">
                    <label for="summary" class="col-form-label">Brève description <span class="text-danger">*</span></label>
                ...
                <div class="form-group">
                    <label for="is_featured">Est parent?</label><br>
                ...
                <div class="form-group">
                    ...
                    <select name="cat_id" id="cat_id" class="form-control">
                        <option value="">--Selectonner une catégorie--</option>
                ...
                <div class="form-group {{ $product->child_cat_id ? '' : 'd-none' }}" id="child_cat_div">
                    ...
                    <select name="child_cat_id" id="child_cat_id" class="form-control">
                        <option value="">--Selectionner une sous catégorie--</option>

                    </select>
                </div>

                <div class="form-group">
                    <label for="price" class="col-form-label">Prix(fcfa) <span class="text-danger">*</span></label>
                    <input id="price" type="number" name="price" placeholder="Entrer le prix"
                ...
                <div class="form-group">
                    ...
                    <input id="discount" type="number" name="discount" min="0" max="100"
                        placeholder="Entrer le pourcentage de reduction" value="{{ $product->discount }}" class="form-control">
                    @error('discount')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="status" class="form-control">
                        <option value="active" {{ $product->status == 'active' ? 'selected' : '' }}>Activer</option>
                        <option value="inactive" {{ $product->status == 'inactive' ? 'selected' : '' }}>Désctiver</option>
                    </select>
                    @error('status')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                ...
                <div class="form-group mb-3">
                    <button class="btn btn-success" type="submit">?ettre à jour</button>
                </div>
            </form>
        </div>
    </div>
