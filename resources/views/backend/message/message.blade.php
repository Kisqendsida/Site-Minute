<div id="messages">
    ...
    <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
        ...
        <div id="message-items">
            ...
            <div>
                <div class="text-truncate">Suis-je un bon garçon ? La raison pour laquelle je demande, c'est parce que quelqu'un m'a dit que les gens disent ça à tous les chiens, même s'ils ne sont pas bons...</div>
                <div class="small text-gray-500">Poulet le chien · 2s</div>
            </div>
            </a> --}}
        </div>
