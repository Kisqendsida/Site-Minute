...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Listes de catégories de publication</h6>
    ...
    <div class="card-body">
      <div class="table-responsive">
        ...
        @else
          <h6 class="text-center">Aucune catégorie de message trouvée !!! Veuillez créer une catégorie de message</h6>
        @endif
      </div>
    </div>
</div>
