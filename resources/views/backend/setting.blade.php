...
<div class="card">
    ...
    <form method="post" action="{{route('settings.update')}}">
        ...
        <div class="form-group">
          <label for="short_des" class="col-form-label">Section footer <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          <label for="description" class="col-form-label">Section à propos <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          <label for="website" class="col-form-label">Site web <span class="text-danger">*</span></label>
          <input type="website" class="form-control" name="website" required value="{{$data->website}}">
          @error('website')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
