...
@section('title','Minute || PRODUCT PAGE')
						...
						<div class="col-lg-3 col-md-4 col-12">
							<div class="shop-sidebar">
								...
								<div class="single-widget range">
									<h3 class="title">Voir par prix</h3>
									...
									@foreach($recent_products as $product)
										...
										<div class="single-post first">
											...
											<div class="content">
												...
												@endphp
												<p class="price"><del class="text-muted">{{$product->price}}</del>   {{number_format($org)}} FCFA </p>                                                
											</div>
										</div>
										<!-- End Single Post -->
									@endforeach
													...
													<div class="list-content">
														<div class="product-content">
															<div class="product-price">
																...
																@endphp
																<span>{{number_format($after_discount)}} FCFA</span>
																<del>{{number_format($product->price)}} FCFA
										...
										<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
											<div class="quickview-content">
												...
												@php
													$after_discount=($product->price-($product->price*$product->discount)/100);
												@endphp
												<h3><small><del class="text-muted">{{$product->price}} FCFA</del></small>    {{$after_discount}}  </h3>
